...
export const LOCAL_FILE_HEADER_MAP: LocalFileByteMapType = {
  ...
  CRC_32: 14, // CRC-32 value
  COMPRESSED_SIZE: 18, // Compressed size
  UNCOMPRESSED_SIZE: 22, // Uncompressed size
  FILENAME_LENGTH: 26, // Filename length
  EXTRA_FIELD: 28 // Extra field length
};

export const DATA_DESCRIPTOR_MAP: DataDescriptorByteMapType = {
...
export const CENTRAL_DIR_MAP: CentralDirByteMapType = {
...
export const END_OF_CENTRAL_DIR_MAP: EndOfCentralDirByteMap = {
